...
public class EventController {
    ...
    @Operation(
            summary = "Get my waitlist position for an event",
            description = "Returns the authenticated user's active waitlist entry and position.",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    ...
    @PreAuthorize("hasAnyAuthority('ORGANIZER', 'ADMIN', 'SUPER_ADMIN')")
    @Operation(
            summary = "Remove a waitlisted user",
            description = "Organizer/admin removes a waitlist entry without promoting them.",
            security = @SecurityRequirement(name = "bearerAuth")
    )
