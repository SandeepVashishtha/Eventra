  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        aria-haspopup="true"
        className="flex items-center gap-2 rounded-full border border-gray-200/80 bg-white/80 hover:bg-white shadow-sm hover:shadow-md dark:border-zinc-700/80 dark:bg-zinc-900/80 dark:hover:bg-zinc-800 p-1 pe-3 backdrop-blur-md transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
      >
        {user?.profilePicture ? (
          <img
            loading="lazy"
      ...
      {isOpen && (
        <div
          ...
          className="absolute end-0 mt-3 w-56 origin-top-right rtl:origin-top-left rounded-xl border border-zinc-100 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md shadow-lg p-2 z-50 animate-in fade-in zoom-in-95 duration-100"
        >
