              ...
              <div className="flex items-center">
                ...
                {!vertical && (
                  <button
                    ...
                    className="ms-0.5 flex-shrink-0 rounded-full p-1.5 hover:bg-bg-secondary transition-colors"
              ...
              {(vertical || isOpen) && (
                <div
                  ...
                  className={
                    vertical
                      ? "mt-1 ms-6 space-y-1"
                      : "absolute start-0 top-full mt-3 w-56 rounded-xl border border-zinc-100 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md p-2 shadow-lg z-50 animate-in fade-in zoom-in-95"
                  }
                >
