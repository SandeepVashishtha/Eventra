        ...
        <div className="flex flex-1 flex-col overflow-y-auto px-6 pt-12 pb-6">
          {!showChat ? (
              ...
              <div className="flex-1 space-y-4">
                <div>
                  <div className="flex items-center gap-2">
                    <h2 id="booth-modal-title" className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-2xl font-bold tracking-tight text-transparent">
                      {booth.label}
                    </h2>
            ...
            <div className="flex min-h-[300px] flex-1 flex-col overflow-hidden rounded-xl border border-white/5 bg-slate-950/80">
              ...
              {/* Input Area */}
              <form onSubmit={handleSendMessage} className="flex gap-2 border-t border-white/5 bg-white/5 p-3">
                <input
                  type="text"
