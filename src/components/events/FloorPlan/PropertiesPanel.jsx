    ...
    <aside className="fp-sidebar fp-sidebar-right" aria-label="Element properties and seating configuration sidebar">
      <div className="fp-sidebar-section">
        ...
        {activeElement.isSponsorBooth && (
          <div className="mb-4 space-y-3 rounded-xl border border-indigo-500/10 bg-indigo-500/5 p-3">
            <div className="mb-1 text-xs font-bold tracking-wider text-indigo-400 uppercase">Sponsor Settings</div>
            <div className="fp-field mb-2">
              <label className="fp-field-label text-[10px]">Sponsor Logo URL</label>
              <input type="text" className="fp-input py-1 text-xs" value={activeElement.sponsorLogo || ""}
            ...
            <div className="fp-field mb-2">
              ...
              <input type="text" className="fp-input py-1 text-xs" value={activeElement.sponsorContact || ""}
            ...
            <div className="fp-field mb-2">
              ...
              <textarea className="fp-input h-16 resize-none py-1 text-xs" value={activeElement.sponsorDescription || ""}
            ...
            <div className="fp-field mb-0">
              ...
              <input type="text" className="fp-input py-1 text-xs" value={activeElement.sponsorJobs || ""}
      ...
      {activeElement.seatsCount > 0 ? (
        <div className="fp-sidebar-section">
          ...
          <div className="mb-2 text-xs font-semibold text-gray-400">Assign registered attendees to table slots:</div>
              ...
              return (
                <div key={seatIdx} className="fp-seat-row flex-col items-stretch gap-2.5" style={{ display: "flex", flexDirection: "column", height: "auto" }}>
                  <div className="flex items-center justify-between gap-2" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <input type="text" className="fp-input h-6 w-28 rounded border border-white/10 bg-white/5 px-2 py-0.5 text-right text-xs hover:border-white/20 focus:border-indigo-500"
                  ...
                  <div className="mt-1 flex items-center justify-between gap-2" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <span className="text-[10px] text-gray-500">Attendee:</span>
                    <select className="fp-attendee-select py-0.5 text-xs"
