    ...
    <aside className="fp-sidebar fp-sidebar-left" aria-label="Floor plan designer tools sidebar">
      <div className="fp-sidebar-section">
        ...
        <p className="mb-4 text-xs text-gray-400 dark:text-gray-500">
          Click items to add them directly onto the seating designer grid canvas.
        </p>
        <div className="fp-tool-grid">
          <button
            className="fp-tool-item"
            aria-pressed="false"
          ...
          <button
            className="fp-tool-item"
            aria-pressed="false"
            onClick={() => onAddElement("rect-table")}
          >
        ...
        <div className="fp-stats-row">
          ...
          <div className="fp-stat-card">
            <div className="fp-stat-val">
              {totalOccupiedSeats} / {totalMaxSeats}
            </div>
      ...
      <div className="fp-sidebar-section fp-portability-section">
        ...
        <div className="fp-portability-grid mb-4">
          <button
            className="fp-portability-btn font-semibold"
        ...
        <button
          className="fp-btn fp-btn-secondary mb-3 w-full justify-center text-xs"
          onClick={handleDownloadJSON}
          title="Download backup config JSON file"
          aria-label="button"
        >
        ...
        <div className="fp-import-zone">
          <label className="fp-import-label cursor-pointer">
            ...
            <span className="text-[11px] font-bold text-gray-300 dark:text-gray-400">
              Restore Layout JSON
            </span>
            <span className="mt-0.5 text-center text-[9px] text-gray-500 dark:text-gray-500">
