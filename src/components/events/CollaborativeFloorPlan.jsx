      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4 shrink-0 overflow-y-auto">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full p-3 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 text-left transition-colors dark:text-gray-200"
            >
              Round Table
            </button>
            <button
        ...
        >
          ...
          {elements.map((el) => (
            <div
              key={el.id}
              className="absolute p-4 bg-white dark:bg-gray-800 border-2 border-indigo-500 shadow-lg rounded-lg text-sm font-medium dark:text-white cursor-move"
