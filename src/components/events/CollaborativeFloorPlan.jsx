...
const CollaborativeFloorPlan = () => {
  ...
  const { users, isConnected, syncStatus, updateCursor, broadcastChange } =
      ...
      <div className="z-10 flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-4 dark:border-gray-700 dark:bg-gray-800">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm">
            {syncStatus === "syncing" && (
              <CloudLightning className="h-4 w-4 animate-pulse text-amber-500" />
            )}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-64 shrink-0 overflow-y-auto border-r border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full rounded-xl border border-gray-200 p-3 text-left transition-colors hover:border-indigo-500 hover:bg-indigo-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-indigo-900/20"
            >
              Round Table
            </button>
            <button
        ...
        >
          ...
          {elements.map((el) => (
            <div
              key={el.id}
              className="absolute cursor-move rounded-lg border-2 border-indigo-500 bg-white p-4 text-sm font-medium shadow-lg dark:bg-gray-800 dark:text-white"
                ...
                >
                  <div style={{ color: u.color }}>
                    <svg
                      ...
                      strokeWidth="2"
                    >
                      <path d="M5.5 3.21V20.8c0 .45.54.67.85.35l4.86-4.86a.5.5 0 01.35-.15h6.8c.45 0 .67-.54.35-.85L6.35 3.21a.5.5 0 00-.85 0z"></path>
                    </svg>
                  </div>
                  <span
