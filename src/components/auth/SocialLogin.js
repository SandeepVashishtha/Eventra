    ...
    <div className="w-full mt-6">
      <div className="relative flex items-center justify-center my-6">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-slate-300/20"></div>
        </div>
        <div className="relative px-4 text-sm bg-transparent text-gray-500 backdrop-blur-sm bg-black/40 rounded-full">
          Or continue with
        </div>
      </div>
