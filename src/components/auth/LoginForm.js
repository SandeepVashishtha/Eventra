      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        >
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-[#0f172a]/60 border border-slate-700/50 rounded-xl placeholder:text-slate-600 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/70 hover:border-slate-600 hover:bg-[#0f172a]/80 transition-all duration-300 text-white text-sm"
          />
        </FormFieldWrapper>
        ...
        <div className="space-y-1.5">
          ...
          >
            <input
              ...
              className="w-full pl-10 pr-10 py-3 bg-[#0f172a]/60 border border-slate-700/50 rounded-xl placeholder:text-slate-600 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/70 hover:border-slate-600 hover:bg-[#0f172a]/80 transition-all duration-300 text-white text-sm"
            />
          </FormFieldWrapper>
