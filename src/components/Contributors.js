...
// ✅ REPLACE the if(loading) block with this
if (loading)
  return (
    <section className="pastel-grid-bg pt-20 md:pt-24 py-20 bg-gradient-to-br from-indigo-50 to-white dark dark:to-black">
      <div className="max-w-7xl mx-auto px-6">
        {/* Search bar skeleton */}
        <div className="flex justify-center mb-8">
          <div className="w-full max-w-2xl h-10 rounded-lg bg-gray-200 dark:bg-gray-700 animate-pulse" />
        </div>
        {/* Title skeleton */}
