          ...
          {STEPS.map((s, i) => {
            ...
            return (
              <div key={s.id} className="flex items-center flex-1 min-w-0">
                ...
                {i < STEPS.length - 1 && (
                  <div
                    className={`flex-1 h-px mx-2 transition-all ${isComplete ? "bg-emerald-400" : "bg-slate-200 dark:bg-slate-700"}`}
                  />
                )}
              </div>
            );
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px] text-blue-700/80 dark:text-blue-400/80 leading-relaxed">
                        ...
                        <code className="font-mono bg-blue-100 dark:bg-blue-900/50 px-1 py-0.5 rounded text-[10px]">
                          repo
                        </code>{" "}
