...
const KeyboardShortcutsHelp = () => {
  ...
  return (
    <article className="col-span-1 rounded-3xl border border-slate-200/70 bg-card-bg/70 p-6 shadow-sm lg:col-span-3 dark:border-slate-700/90">
        ...
        <table className="w-full border-collapse text-left">
          <thead>
            <tr className="border-slate-150 border-b dark:border-slate-800">
              <th className="py-3 text-xs font-bold tracking-wider text-slate-400 uppercase">Shortcut</th>
              <th className="py-3 text-xs font-bold tracking-wider text-slate-400 uppercase">Action</th>
            </tr>
          </thead>
                  ...
                  <div className="flex items-center gap-1.5">
                    {s.keys.map((k, kIdx) => (
                      <React.Fragment key={kIdx}>
                        {kIdx > 0 && <span className="text-slate-450 text-xs font-bold dark:text-slate-500">+</span>}
