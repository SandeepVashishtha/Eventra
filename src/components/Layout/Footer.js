...
const Footer = () => {
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
      ...
      <div className="mt-6 max-w-full mx-auto px-6 py-8 grid lg:grid-cols-3 gap-x-12 gap-y-12 bg-linear-to-t from-slate-50 dark:from-slate-900">

        {/* BRAND */}
        <div className="lg:col-span-5 flex flex-col gap-6 items-center lg:translate-x-8">
