...
const socialLinks = [
  { name: "GitHub", href: "https://github.com/sandeepvashishtha/Eventra", icon: FaGithub },
  { name: "LinkedIn", href: "https://www.linkedin.com/in/sandeepvashishtha/", icon: FaLinkedin },
  { name: "Discord", href: "https://www.discord.com/", icon: FaDiscord },
  { name: "Telegram", href: "https://www.telegram.com/", icon: FaTelegram },
  ...
  return (
    <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
      <p className="text-sm text-gray-500 dark:text-gray-400 text-center md:text-left">
        © {currentYear} Eventra. All rights reserved. Created with love by Sandeep Vashishtha, Rhythm and the amazing open-source community.
      </p>
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          <div className="space-y-4 lg:col-span-2" data-aos="fade-up" data-aos-delay="0">
            <h2
