...
const CertificateDownload = ({ user, eventName, eventDate, eventType, organizerName, template = 'classic' }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const participantName = `${user.firstName || ""} ${user.lastName || user.name || ""}`.trim() || "Guest Participant";
