  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="absolute right-0 z-dropdown mt-2 w-[min(100vw-1rem,24rem)] origin-top-right overflow-hidden rounded-xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-900"
        role="dialog"
