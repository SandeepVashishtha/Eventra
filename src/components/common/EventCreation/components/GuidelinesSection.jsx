  ...
  return (
    ...
    >
      ...
      <ul className="list-disc space-y-3 pl-6 text-sm text-gray-700 sm:text-base dark:text-gray-300">
        <li>
          Provide a <span className="font-medium">clear and catchy title</span> that accurately
          represents your event (3-200 characters).
        </li>
        <li>
        ...
        <li>
          Set <span className="font-medium">accurate dates and times</span> to avoid confusion. Make
          sure the end time is after the start time.
        </li>
        <li>
        ...
        <li>
          Define <span className="font-medium">ticket tiers</span> if applicable, with clear pricing
          and capacity limits.
        </li>
        <li>
        ...
        <li>
          Upload an <span className="font-medium">eye-catching banner image</span> (max 5MB) to make
          your event stand out.
        </li>
        <li>
          Review all details in the <span className="font-medium">preview</span> before publishing
          your event.
        </li>
      </ul>
    </motion.div>
