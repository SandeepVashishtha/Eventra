...
const TicketTiersSection = ({ formData, setFormData, errors, setErrors }) => {
  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center gap-2">
        ...
        <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Ticket Tiers</h3>
      </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  } rounded-lg bg-white p-3 text-gray-900 dark:bg-gray-700 dark:text-gray-100`}
                />
