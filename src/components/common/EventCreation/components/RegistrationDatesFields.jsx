  ...
  return (
    ...
    >
      <div>
        ...
        />
        {errors.registrationStart && <span className="mt-1 text-sm text-red-500">{errors.registrationStart}</span>}
      </div>
      <div>
        <label className="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
        ...
        />
        {errors.registrationEnd && <span className="mt-1 text-sm text-red-500">{errors.registrationEnd}</span>}
      </div>
    </motion.div>
  );
}
