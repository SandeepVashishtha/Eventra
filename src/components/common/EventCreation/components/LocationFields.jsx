    ...
    return (
      ...
      >
        ...
        <input
          ...
          className={`w-full border ${errors.virtualLink ? "border-red-500" : "border-gray-300 dark:border-gray-600"} rounded-lg bg-white p-3 text-gray-900 transition-all duration-300 focus:ring-1 focus:ring-indigo-500 focus:outline-none dark:bg-gray-700 dark:text-gray-100 dark:focus:ring-indigo-400`}
        />
        {errors.virtualLink && (
    ...
    <>
      ...
      >
        ...
        <input
          ...
          className={`w-full border ${errors.location ? "border-red-500" : "border-gray-300 dark:border-gray-600"} rounded-lg bg-white p-3 text-gray-900 transition-all duration-300 focus:ring-1 focus:ring-indigo-500 focus:outline-none dark:bg-gray-700 dark:text-gray-100 dark:focus:ring-indigo-400`}
        />
