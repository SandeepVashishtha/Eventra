...
const ShareMenu = ({
  ...
  return (
    <div
      className={`share-menu-container relative z-[200] inline-block ${className}`}
      ref={menuRef}
    >
      {/* Share Button */}
      <button
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`share-menu-dropdown absolute z-[9999] ${positionClasses[currentPosition]} rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-900 ${menuClassName}`}
            role="menu"
