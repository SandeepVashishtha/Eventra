      ...
      >
        ...
        >
          ...
          <input
            ...
            className="flex-1 w-full bg-transparent border-none outline-none text-slate-900 dark:text-white placeholder:text-slate-500 dark:placeholder:text-slate-400 text-sm sm:text-base pr-12 truncate"
            spellCheck={false}
            value={value}
            onChange={onChange}
            onFocus={handleFocus}
