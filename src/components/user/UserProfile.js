...
const ACTIVITY_STATS = [
  ...
  },
  {
    label: "Hackathons",
    value: 4,
    sub: "2 hosted · 2 joined",
    icon: <Trophy size={18} />,
    colorClass: "text-pink-600 bg-pink-500/10 dark:text-pink-400 dark:bg-pink-500/20",
  },
  {
    label: "Projects",
    value: 2,
...
export default function UserProfile() {
  ...
  return (
    <div className="upv-root">
      <motion.div className="upv-container" variants={stagger} initial="hidden" animate="visible">
        {/* ── Hero / Avatar card ── */}
        <motion.div custom={0} variants={fadeUp(prefersReducedMotion)} className="upv-hero-card">
          ...
          <div className="upv-hero-content">
            ...
            <div className="upv-hero-info">
              ...
              {profile?.bio && <p className="upv-bio">{profile.bio}</p>}
            </div>
        ...
        <div className="upv-body">
            ...
            {hasSocials && (
              <motion.div custom={3} variants={fadeUp(prefersReducedMotion)} className="upv-card">
                ...
                <div className="upv-socials">
                  {profile?.github && (
                    <a
                      href={sanitizeUrl(profile.github)}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="upv-social-link upv-social-github"
                    >
                      <Github size={16} />
                      <span>GitHub</span>
                  ...
                  {profile?.linkedin && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="upv-social-link upv-social-linkedin"
                    >
                      <Linkedin size={16} />
                      <span>LinkedIn</span>
                      <ChevronRight size={13} className="upv-social-arrow" />
                  ...
                  {profile?.portfolio && (
                    <a
                      href={sanitizeUrl(profile.portfolio)}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="upv-social-link upv-social-portfolio"
                    >
                      <Globe size={16} />
                      <span>Portfolio</span>
                      <ChevronRight size={13} className="upv-social-arrow" />
          ...
          <div className="upv-right">
            ...
            <motion.div custom={1} variants={fadeUp(prefersReducedMotion)} className="upv-card">
              ...
              <div className="upv-stats-grid">
                {ACTIVITY_STATS.map((s, i) => (
                  ...
                  >
                    <span className={`upv-stat-icon ${s.colorClass}`}>{s.icon}</span>
            ...
            <motion.div custom={2} variants={fadeUp(prefersReducedMotion)} className="upv-card">
              ...
              {skills.length > 0 ? (
                ...
                <p className="upv-empty-msg">
                  No skills added yet.{" "}
                  <Link to="/profile/edit" className="upv-inline-link">
                    Add some →
                  </Link>
                </p>
              )}
            ...
            <motion.div
              custom={3}
              variants={fadeUp(prefersReducedMotion)}
              className="upv-card upv-achievements-card"
            >
              <div className="upv-card-header">
              ...
              <Link
                ...
                className="upv-achievements-btn"
