      ...
      >
        ...
        <div className="flex flex-col justify-between space-y-6">
                ...
                <div className="flex gap-2">
                  {Object.values(BADGE_TEMPLATES).map((t) => (
                    <button
                      ...
                      className={`cursor-pointer rounded-xl border px-3 py-1.5 text-[10px] font-extrabold tracking-wide uppercase transition ${
          ...
          <div className="space-y-3 border-t border-slate-800 pt-6">
            ...
            {exporting && (
              <p className="text-slate-550 animate-pulse text-center text-[10px] font-medium">
        ...
        <div className="border-slate-850 relative flex items-center justify-center overflow-hidden rounded-2xl border bg-slate-950/30 p-4">
          ...
          <div
            ref={badgeRef}
            className={`h-[400px] w-[260px] bg-gradient-to-b ${currentTemplate.bgGradient} border-2 ${currentTemplate.borderClass} relative flex flex-col items-center justify-between overflow-hidden rounded-3xl p-5 select-none`}
            style={{ fontFamily: "Inter, sans-serif" }}
          >
            {/* Template Ambient Glow Overlay */}
            <div
              className={`absolute -top-12 -left-12 h-28 w-28 ${currentTemplate.glowClass} pointer-events-none rounded-full blur-2xl`}
            />
            <div
              className={`absolute -right-12 -bottom-12 h-28 w-28 ${currentTemplate.glowClass} pointer-events-none rounded-full blur-2xl`}
            />
            ...
            <div className="z-10 flex w-full items-center justify-between border-b border-white/10 pb-2">
              ...
              <span
                className={`rounded-full border px-2 py-0.5 text-[8px] font-extrabold ${currentTemplate.badgeLabelClass}`}
              >
            ...
            <div className="z-10 mt-3 flex flex-col items-center space-y-3">
              <div className="relative">
                {/* Aura border */}
                <span
                  className={`absolute -inset-1 rounded-full bg-gradient-to-r ${currentTemplate.ringClass} animate-pulse opacity-80 blur-xs`}
                />
                ...
                {isFullyVerified && (
                  <div
                    className="absolute -right-1 -bottom-1 flex h-5 w-5 items-center justify-center rounded-full border border-slate-950 bg-emerald-500 text-white shadow"
              ...
              <div className="space-y-0.5 text-center">
                <h4 className="text-sm leading-none font-black tracking-tight text-white">
                  {attendeeName}
                </h4>
                <p className="text-slate-450 text-[9px] font-extrabold tracking-widest uppercase">
                  {attendeeRole}
                </p>
              </div>
            </div>
            ...
            <div className="border-slate-850 z-10 flex w-full justify-around rounded-2xl border bg-slate-950/70 p-2.5 text-center">
              <div>
                <span className="block text-[7px] font-black tracking-wider text-slate-400 uppercase">
                  Events
                </span>
            ...
            <div className="z-10 flex w-full items-center justify-between border-t border-white/5 pt-2">
              <div className="text-left">
                <span className="text-slate-550 block text-[7px] leading-none font-black tracking-wide uppercase">
                  Security Verification
                </span>
                <span className="mt-1 block text-[8px] font-black tracking-wider text-slate-400 uppercase">
                  Verified Member
                </span>
              </div>
