  ...
  return (
    <div className="min-h-screen bg-slate-900 p-4 text-white">
      ...
      <div className="mb-4 flex gap-4">
        <button onClick={addTable} className="rounded bg-blue-600 px-4 py-2">Add Round Table</button>
        <button onClick={saveLayout} className="rounded bg-green-600 px-4 py-2">Save Layout</button>
      </div>
