        ...
        <footer className="ad-footer">
          ...
          <div className="ad-footer-content">
            ...
            <div className="ad-footer-links">
              ...
              <a href={`https://github.com/${import.meta.env.REACT_APP_GITHUB_REPO || 'sandeepvashishtha/Eventra'}`} target="_blank" rel="noopener noreferrer" className="ad-footer-link">GitHub</a>
