      ...
      <section className="space-y-8">
        ...
        <div className="flex flex-wrap items-center gap-12">
          <Tooltip content="Tooltip at the top!" position="top">
            <button className="rounded-xl border border-gray-200 bg-white px-6 py-2 font-bold shadow-sm dark:border-gray-700 dark:bg-gray-800">Top Hover</button>
          </Tooltip>
          <Tooltip content="Tooltip at the bottom!" position="bottom">
            <button className="rounded-xl border border-gray-200 bg-white px-6 py-2 font-bold shadow-sm dark:border-gray-700 dark:bg-gray-800">Bottom Hover</button>
          </Tooltip>
