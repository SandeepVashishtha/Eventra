    ...
    <div className="max-w-6xl mx-auto px-4 py-12 space-y-16 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="space-y-4">
        <h1 className="text-4xl font-black text-gray-900 dark:text-white flex items-center gap-3">
          <Package className="text-indigo-600" size={36} aria-hidden="true" />
      ...
      <section className="space-y-8">
        <div className="flex items-center gap-2 border-b border-gray-200 dark:border-gray-800 pb-4">
          <MessageCircle className="text-indigo-500" size={24} aria-hidden="true" />
          <h2 className="text-2xl font-bold dark:text-white">Tooltips</h2>
        </div>
        <div className="flex flex-wrap gap-12 items-center">
          <Tooltip content="Tooltip at the top!" position="top">
            <button type="button" className="px-6 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl font-bold shadow-sm">Top Hover</button>
          </Tooltip>
          <Tooltip content="Tooltip at the bottom!" position="bottom">
            <button type="button" className="px-6 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl font-bold shadow-sm">Bottom Hover</button>
          </Tooltip>
