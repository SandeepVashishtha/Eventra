...
export function getSecurityConfigurationWarnings(config = {}, environment = "development") {
  const warnings = [];
  ...
  } else if (environment === "production" && apiEndpoint.startsWith("http://")) {
    warnings.push("Insecure API endpoint: HTTPS is required in production.");
  }
