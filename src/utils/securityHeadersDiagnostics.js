export const getSecurityHeadersDiagnostics = () => {
  ...
  diagnostics.push({
    ...
    recommendation: cspMeta ? "CSP is configured." : "Verify CSP deployment headers.",
  });

  diagnostics.push({
    name: "CSP Reporting",
    value: process.env.REACT_APP_CSP_REPORT_URI || "Not configured",
    status: process.env.REACT_APP_CSP_REPORT_URI ? "success" : "warning",
    recommendation: process.env.REACT_APP_CSP_REPORT_URI
