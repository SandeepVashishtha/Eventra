...
describe("User Storage Abstraction Layer", () => {
  ...
  describe("In-Memory Storage Backend (Development)", () => {
    ...
    it("should initialize in-memory storage in development", async () => {
      const { getStorageBackend, isStorageHealthy } =
        await import("../../api/auth/user-storage.js");
    ...
    it("should reject duplicate email addresses", async () => {
      ...
      await expect(createUser(user2)).rejects.toThrow("User with this email already exists");
    });
    ...
    it("should reject duplicate usernames", async () => {
      ...
      await expect(createUser(user2)).rejects.toThrow("User with this username already exists");
    });

    it("should update user", async () => {
      const { createUser, updateUser, getUserById } =
        await import("../../api/auth/user-storage.js");
    ...
    it("should return null for non-existent user", async () => {
      const { getUserByEmail, getUserByUsername, getUserById } =
        await import("../../api/auth/user-storage.js");
  ...
  describe("Persistence Tests", () => {
    ...
    it("should survive storage reinitialization", async () => {
      const { createUser, getUserByEmail, resetStorageBackend } =
        await import("../../api/auth/user-storage.js");
    ...
    it("should handle multiple operations correctly", async () => {
      const { createUser, getUserByEmail, getUserById } =
        await import("../../api/auth/user-storage.js");
  ...
  describe("Authentication Regression Tests", () => {
    ...
    it("should support user lookup by email or username", async () => {
      const { createUser, getUserByEmail, getUserByUsername } =
        await import("../../api/auth/user-storage.js");
  ...
  describe("Storage Backend Classes", () => {
    it("should throw error for unimplemented methods in base class", async () => {
      ...
      await expect(backend.getUserByEmail("")).rejects.toThrow(
        "getUserByEmail() must be implemented"
      );
      await expect(backend.getUserByUsername("")).rejects.toThrow(
        "getUserByUsername() must be implemented"
      );
