    ...
    <section className="relative min-h-[82vh] flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-black dark:to-gray-900 overflow-hidden py-16">
      ...
      >
        <motion.h1
          ...
          data-aos-delay="100"
        >
          About <span className="dark:text-white text-black">Us</span>
        </motion.h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-black  dark:text-white text-sm">Events Managed</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-black dark:text-white text-sm">Active Users</p>
          </motion.div>
          <motion.div
            variants={cardItem}
            // UPDATED: Card background and shadow
          ...
          >
            ...
            <p className="text-black dark:text-white text-sm">Community Reach</p>
          </motion.div>
        </div>
      </div>
    </section>
