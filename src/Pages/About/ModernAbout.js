...
// ADDED: Missing values data
const values = [
  { title: "Open Source", desc: "Free for everyone, forever", color: "", border: "" },
  { title: "Community First", desc: "Built by and for communities", color: "", border: "" },
  { title: "Innovation", desc: "Always improving", color: "", border: "" },
  { title: "Accessibility", desc: "Easy for everyone to use", color: "", border: "" },
];
...
// FIXED: MissionSection component
