      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-[380px_1fr] gap-6">
          ...
          <div className="bg-card-bg rounded-2xl p-6 border border-border shadow-sm h-fit">
            <h2 className="text-xl font-semibold text-text mb-5">Your Preferences</h2>

            <div className="space-y-4">
              {/* Interests */}
              <div>
                <label className="block text-sm font-medium mb-2 text-text-light">Interests</label>
              ...
              {/* Event Type */}
              <div>
                <label className="block text-sm font-medium mb-2 text-text-light">Event Type</label>
          ...
          <div className="bg-card-bg rounded-2xl p-6 border border-border shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-text">Recommended Events</h2>
                  ...
                  {recommendedEvents.map((event) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs text-text-light">{event.tag}</span>
                      </div>

                      <h3
                        title={event.title}
                        className="text-lg font-bold text-text line-clamp-2 break-words min-w-0"
                      >
                        {event.title}
                      </h3>

                      <p className="mt-2 text-sm text-text-light">{event.description}</p>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {otherEvents.map((event) => (
                        <div key={event.id} className="rounded-2xl border border-border p-5 bg-bg">
                          <h3
                            title={event.title}
                            className="text-lg font-bold text-text line-clamp-2 break-words min-w-0"
                          >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs transition-opacity">
          <div className="relative w-full max-w-lg bg-card-bg border border-border rounded-3xl p-6 shadow-2xl overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              {/* Breakdown Matrix */}
              <div className="space-y-3">
                <span className="text-xs font-extrabold text-text-light/60 uppercase tracking-widest block">
              ...
              <div className="mt-6">
                <h3 className="text-lg font-semibold mb-3 text-text">AI Recommendation Insights</h3>
