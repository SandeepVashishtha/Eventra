    ...
    <div className="mb-8 flex flex-col gap-4 rounded-[28px] border border-slate-200/70 bg-white/80 p-4 shadow-[0_16px_50px_rgba(15,23,42,0.06)] backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
      <div className="relative w-full sm:max-w-xs">
        ...
        <input
          ...
          className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-2.5 pr-4 pl-10 text-sm text-slate-950 transition-all placeholder:text-slate-400 focus:border-slate-300 focus:ring-2 focus:ring-[#E0E9F2] focus:outline-none"
      ...
      <div className="flex items-center gap-3">
        <StyledDropdown
          ...
          icon={<Filter className="h-3 w-3" aria-hidden="true" />}
        />
