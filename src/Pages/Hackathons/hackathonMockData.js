const data = [
...

  {
    ...
    organizer: "EcoFuture Labs",
    difficulty: "Beginner",
    techStack: ["React", "Node.js", "MongoDB", "IoT"],
    rules: ["Green technology focus", "Prototype required", "Max 4 members"],
    winner: "",
    featured: false,
  },

  {
    ...
    techStack: ["Blockchain", "Solidity", "Ethereum", "React"],
    rules: ["No copied projects", "Live demo required", "Original code only"],
    winner: "Team Nexus",
    featured: false,
  },

  {
    ...
    submissions: 95,
    prize: "$20,000",
    description: "Create immersive virtual reality experiences for future.",
    location: "Los Angeles, CA",
    organizer: "VRX Studios",
    difficulty: "Intermediate",
...

  {
    ...
    submissions: 0,
    prize: "$10,000",
    description: "Build a project in a coding bootcamp using latest techstack.",
    location: "Online",
    organizer: "CodeSprint",
    difficulty: "Beginner",
    techStack: ["HTML", "CSS", "JavaScript", "React"],
    rules: ["Individual or team participation", "Must submit GitHub repo", "Presentation required"],
    winner: "",
    featured: false,
  },

  {
    ...
    organizer: "ChainLabs",
    difficulty: "Advanced",
    techStack: ["Blockchain", "Ethereum", "Solidity", "Web3.js"],
    rules: ["Smart contracts required", "Live blockchain demo", "No copied code"],
    winner: "Crypto Titans",
    featured: false,
  },
];
export default data;
