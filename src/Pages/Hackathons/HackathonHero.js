...
//             <div className="flex flex-wrap items-center gap-2 w-full pl-12 pr-12 py-4 text-base text-gray-900 dark:text-gray-100 bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg">
//               <AnimatePresence>
...
//                     ? "Search hackathons by name, location, or tags..."
//                     : ""
//                 }
...
//             whileTap={{ scale: 0.95 }}
//             className="px-7 py-3.5 rounded-xl font-semibold text-black shadow-lg bg-blue-100 hover:bg-blue-200 transition-all duration-300"
...
//             }}
//             className="px-7 py-3.5 rounded-xl font-medium text-black shadow-md bg-green-100 hover:bg-green-200 transition-all duration-300"
//           >
//             <span className="flex items-center">
...
//       {/* Stats Section - Hidden while searching */}
...
//             >
//               <div className="mb-4 flex items-center justify-center h-14 w-14 rounded-full bg-gradient-to-tr from-blue-200 to-sky-100 shadow-md">
