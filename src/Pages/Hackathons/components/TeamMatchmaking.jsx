                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3">
                        ...
                        <span
                          className="text-[10px] font-bold text-slate-400 truncate max-w-[130px]"
                      ...
                      <div className="flex items-start justify-between gap-3 mb-4">
                        ...
                        <div
                          className={`px-2.5 py-1.5 rounded-xl border text-[11px] font-black flex items-center gap-1 ${scoreColor}`}
                        >
                        ...
                        <div className="border-t border-slate-100 dark:border-slate-850/60 pt-4 mb-4">
                          ...
                          <AnimatePresence>
                            {isExpanded && (
                              ...
                              >
                                <div className="text-[10px] text-slate-400 mb-1.5 uppercase font-bold">
