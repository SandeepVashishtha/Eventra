...
example: `curl -X GET ${import.meta.env.REACT_APP_API_URL}/projects?hackathonId=1`,
    response: `[
  {
    "id": 42,
  ...
  example: `fetch("${import.meta.env.REACT_APP_API_URL}/contributors", {
  ...
  },
  {
    ...
    example: `curl -X GET \${import.meta.env.REACT_APP_API_URL}/leaderboard?limit=10`,
    response: `[
  {
    "rank": 1,
    "username": "coder123",
