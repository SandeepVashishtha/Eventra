    ...
    <section className="bg-bg text-text min-h-screen py-24">
      <div className="mx-auto max-w-5xl space-y-8 px-4 sm:px-6 lg:px-8">
        <div className="space-y-3">
          <p className="text-sm font-semibold tracking-[0.3em] text-indigo-600 uppercase dark:text-indigo-400">
            User Settings
          </p>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {/* Appearance */}
          <article className="bg-card-bg/70 rounded-3xl border border-slate-200/70 p-6 shadow-sm dark:border-slate-700/90">
            ...
            <div className="space-y-3">
              <button
                ...
                className="bg-bg inline-flex w-full items-center justify-between rounded-2xl border border-slate-200 px-4 py-3 text-left text-sm font-medium text-slate-800 transition hover:border-indigo-400 hover:bg-indigo-50 dark:border-slate-700 dark:text-slate-100 dark:hover:bg-slate-900"
              >
                <span className="flex items-center gap-3">
                  <MousePointer className="h-5 w-5 text-emerald-500" aria-hidden="true" />
          ...
          <article className="bg-card-bg/70 rounded-3xl border border-slate-200/70 p-6 shadow-sm dark:border-slate-700/90">
            <div className="mb-4 flex items-center gap-3 text-slate-900 dark:text-slate-100">
              <Bell className="h-6 w-6 text-cyan-500" aria-hidden="true" />
              <div>
            ...
            <div className="space-y-3">
              ...
              >
                <span className="flex items-center gap-3">
                  <SlidersHorizontal className="h-5 w-5 text-cyan-500" aria-hidden="true" />
        ...
        <section className="bg-card-bg/70 animate-fadeIn space-y-6 rounded-3xl border border-slate-200/70 p-6 shadow-sm dark:border-slate-800">
          ...
          <div className="bg-card-bg/50 space-y-4 rounded-2xl border border-slate-200/60 p-5 dark:border-slate-800/80">
            {backupKey ? (
              <div className="space-y-4">
                ...
                <div className="relative">
                  <div className="bg-bg dark:border-slate-850 rounded-xl border border-slate-200 p-4 pr-20 font-mono text-xs leading-relaxed break-all select-all">
                    {showKey ? (
                      <div className="space-y-2.5">
                        ...
                        <div className="dark:border-slate-850/60 border-t border-slate-200 pt-2">
                          <span className="mb-1 block text-[10px] font-black tracking-widest text-slate-400 uppercase">
                            Hex Seed (256-bit):
                          </span>
                  ...
                  <div className="absolute top-1/2 right-2 flex -translate-y-1/2 items-center gap-1.5">
                    <button
                      ...
                      className="cursor-pointer rounded-lg border border-slate-200 bg-white p-2 text-slate-500 transition hover:text-slate-800 dark:border-slate-800 dark:bg-slate-900 dark:hover:text-slate-200"
                ...
                <div className="flex flex-wrap gap-2.5 pt-1">
                  <button
                    ...
                    className="dark:hover:bg-slate-850 inline-flex cursor-pointer items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-700 transition hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
                    aria-label="button"
                  >
                    <Download size={13} />
                  ...
                  <button
                    ...
                    className="dark:hover:bg-slate-850 inline-flex cursor-pointer items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-700 transition hover:bg-slate-50 disabled:opacity-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
                    aria-label="button"
                  >
              ...
              <div className="flex flex-col items-start justify-between gap-4 py-2 sm:flex-row sm:items-center">
                ...
                <button
                  onClick={generateBackupKey}
                  disabled={isGenerating}
                  className="bg-indigo-650 flex shrink-0 cursor-pointer items-center gap-1.5 rounded-xl px-5 py-2.5 text-xs font-bold text-white shadow-md shadow-indigo-500/10 transition hover:bg-indigo-700 disabled:opacity-50"
                  aria-label="button"
                >
          ...
          <div className="text-rose-650 dark:text-rose-455 flex items-start gap-2.5 rounded-2xl border border-rose-100/30 bg-rose-50/50 p-3 text-xs leading-relaxed dark:border-rose-900/10 dark:bg-rose-950/10">
        ...
        <div className="bg-card-bg/70 rounded-3xl border border-slate-200/70 p-6 shadow-sm dark:border-slate-700/90">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="bg-bg inline-flex cursor-pointer items-center gap-2 rounded-2xl border border-slate-200 px-4 py-3 text-sm font-medium text-slate-800 transition hover:border-indigo-400 hover:bg-indigo-50 dark:border-slate-700 dark:text-slate-100 dark:hover:bg-slate-900"
              >
                Reset Onboarding
              </button>
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-2xl bg-black px-4 py-3 text-sm font-medium text-white transition hover:bg-slate-900"
              >
                Edit Profile
