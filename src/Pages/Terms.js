...
const SECTIONS = [
  {
    ...
    content: (
      <p className="text-text-light leading-relaxed">
        By accessing or using <span className="font-semibold text-primary">Eventra</span>, you
  ...
  },
  {
    ...
    content: (
      <p className="text-text-light leading-relaxed">
        The <span className="font-semibold text-primary">Eventra</span> platform and its original
  ...
  },
  {
    ...
    content: (
      <p className="text-text-light leading-relaxed">
        ...
        <span className="font-semibold text-primary">30 days&apos; notice</span> prior to any new
...
const AccordionSection = ({ section, isOpen, onToggle, animateIn }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-0 top-4 bottom-4 w-0.5 rounded-full ${isOpen ? (["indigo", "sky", "emerald"].includes(section.color) ? "bg-primary" : "bg-secondary") : "bg-transparent"} transition-all duration-300`}
      />
      ...
      >
        <div className="flex items-center gap-4">
          {/* Numbered badge */}
          <div
            className={`flex-shrink-0 w-8 h-8 rounded-xl ${c.badge} flex items-center justify-center font-bold text-sm transition-all duration-300`}
          >
            {section.id}
          </div>
          ...
          {/* Title */}
          <h2 className="text-base font-semibold text-text leading-snug">{section.title}</h2>
        </div>

        {/* Chevron */}
        <span
          className={`flex-shrink-0 p-2 rounded-lg bg-slate-50 dark:bg-white/5 border border-border
    ...
    <div className="relative min-h-screen bg-bg text-text overflow-x-hidden">
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 overflow-hidden">
        <div
          ...
          bg-primary/10 dark:bg-primary/5 blur-[100px] animate-pulse"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full
          bg-secondary/10 dark:bg-secondary/5 blur-[100px] animate-pulse"
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-20">
        ...
        >
          ...
          <div
            aria-hidden
            className="absolute -top-8 -right-8 w-40 h-40 rounded-full bg-white/10 blur-md"
          />
          <div
            aria-hidden
              ...
              <nav className="space-y-1">
                {SECTIONS.map((s) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`flex-shrink-0 font-bold text-xs ${isActive ? "text-primary" : "text-text-light/60"}`}
                      >
