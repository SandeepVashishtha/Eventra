    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Sync your Eventra registrations with your personal primary calendars.
          </p>
        </div>
        <button
        ...
        {connectedAccounts.map((acc) => (
          ...
          >
            <div className="flex items-center gap-5">
              <div
                className={`p-4 rounded-2xl ${acc.connected ? "bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400" : "bg-gray-100 dark:bg-gray-700 text-gray-400"}`}
              >
                <Settings size={28} />
              </div>
              <div>
      ...
      <div className="mt-12 p-6 bg-indigo-50 dark:bg-indigo-900/10 rounded-3xl border border-indigo-100 dark:border-indigo-800/30">
        <h4 className="font-bold text-indigo-900 dark:text-indigo-300 mb-2">
          Pro Tip: iCal Subscriptions
        </h4>
        <p className="text-sm text-indigo-700/80 dark:text-indigo-400/80 leading-relaxed">
          Don&apos;t want to use OAuth? You can also subscribe to your personalized Eventra iCal
          feed. This provides a one-way sync to any calendar app that supports URL-based
          subscriptions.
        </p>
        <button className="mt-4 text-sm font-black text-indigo-600 dark:text-indigo-400 hover:underline">
          Copy iCal URL
        </button>
      </div>
    </div>
