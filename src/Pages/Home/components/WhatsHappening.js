        ...
        >
          ...
          <div className="absolute top-3 right-3 sm:top-4 sm:right-4 z-20">
            <button
              ...
              aria-label={
                isAutoPlaying ? "Pause automatic slide rotation" : "Resume automatic slide rotation"
              }
              ...
              >
                {isLoading
                  ? [...Array(cardsPerView)].map((_, i) => (
                      <div
                        key={`skeleton-wrap-${i}`}
                        className="p-1 rounded-[24px] border-2 border-brand-violet/20"
                      ...
                      .map((event) => (
                        ...
                        >
                          ...
                          <div className="flex flex-col flex-1">
                            ...
                            <h3
                              title={event.title}
                              className="text-lg sm:text-xl font-semibold text-slate-900 dark:text-white mb-2 leading-snug group-hover:text-brand-violet dark:group-hover:text-brand-violet transition-colors line-clamp-2 break-words min-w-0"
                            >
                              {event.title}
                            </h3>
                            ...
                            <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-100 dark:border-slate-800">
                              <div className="flex items-center text-xs font-medium text-slate-500 dark:text-slate-400">
                                <svg
                                  className="w-4 h-4 mr-1.5 text-slate-400 dark:text-slate-500"
                                  fill="none"
                                  stroke="currentColor"
                                  strokeWidth="2"
                                  viewBox="0 0 24 24"
