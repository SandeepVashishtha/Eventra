      ...
      <div className="max-w-7xl mx-auto mb-6 flex items-center justify-center gap-4">
        ...
        >
          {isPlaying ? (
            ...
            <Play className="text-indigo-600 dark:text-indigo-400 ml-0.5" />
          )}
        </button>
              ...
              return (
                ...
                >
                  ...
                  {testimonial.verified && (
                    <div
                      className="absolute -top-2 -right-2 bg-green-500 text-white text-xs px-2 py-0.5 rounded-full flex items-center gap-1 shadow-md"
                  ...
                  {/* 💬 Quote Icon */}
                  <Quote
                    className="absolute top-4 left-4 text-gray-300 dark:text-gray-800 text-4xl -z-10 opacity-50"
                    aria-hidden="true"
                  />
                  ...
                  {/* ⭐ Rating Stars */}
                  <div
                    className="absolute bottom-4 right-4 flex gap-0.5"
