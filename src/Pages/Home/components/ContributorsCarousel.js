  ...
  />
                    ...
                    <div className="mt-16">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 text-sm font-medium mb-3 flex items-center justify-center gap-1">
                        <Medal className="text-yellow-500 w-4 h-4" />{" "}
                        {c.role}
                      </p>
                    ...
                    <div className="grid grid-cols-3 gap-3 text-sm text-gray-900 dark:text-white my-3 w-full">
                      ...
                      <div className="flex flex-col items-center bg-white/60 dark:bg-gray-700/60 backdrop-blur-md p-2 rounded-lg shadow-sm">
                        <Users className="text-gray-900 dark:text-indigo-400 mb-1 w-4 h-4" />
                    ...
                    <div className="mt-auto w-full">
                      ...
                      >
                        ...
                        <Github className="text-lg transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110 group-hover:text-gray-200 w-5 h-5" />

                        <span>Profile</span>

                        <ExternalLink className="text-sm opacity-80 transition-transform duration-300 group-hover:translate-x-1 w-4 h-4" />
                      </a>
                    </div>
                  </motion.div>
                );
          ...
          <div className="flex justify-center mt-8">
            ...
            >
              ...
              <ExternalLink className="text-sm w-4 h-4" />
            </Link>
            <Link
              to="/ContributorGuide"
              onClick={() => window.scrollTo(0, 0)}
