...
<div className="px-8 py-6 grid grid-cols-1 sm:grid-cols-3 gap-4 bg-gradient-to-r from-gray-50/30 to-white/60 dark:from-gray-800/30 dark:to-gray-900/60">
  ...
  {/* Contact Now Button */}
  <a
    href={`mailto:${event.contactEmail || "organizer@eventra.com"}`}
    className="group/btn"
  >
    <div
      className="inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-600 text-white px-6 py-3 text-sm font-bold shadow-lg hover:bg-indigo-700 hover:shadow-xl transition-all duration-300 w-full"
    >
      Contact Now
    </div>
  </a>
