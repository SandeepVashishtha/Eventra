  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-md overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-2xl dark:border-gray-800 dark:bg-gray-900"
      >
        <button
          onClick={onClose}
        ...
        <div className="space-y-4 p-5">
          <div className="grid grid-cols-2 gap-3 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="col-span-2 flex items-center gap-2">
              <Tag size={16} className="shrink-0 text-green-500" />
          ...
          <div className="flex gap-3 pt-2">
            <Link
              ...
              className="flex flex-1 justify-center rounded-xl border border-gray-200 py-2.5 font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
            >
              View Details
            </Link>
            <Link
              to={`/events/${event.resource.id}/register`}
              className="flex flex-1 justify-center rounded-xl bg-indigo-600 py-2.5 font-semibold text-white shadow-lg shadow-indigo-600/20 transition-colors hover:bg-indigo-700"
            >
              Register
            </Link>
          </div>
...
const EventCalendarView = ({ events }) => {
  ...
  return (
    <div className="calendar-container mb-8 overflow-hidden rounded-3xl border border-gray-100 bg-white p-4 shadow-xl sm:p-6 dark:border-gray-800 dark:bg-gray-900">
      <style
