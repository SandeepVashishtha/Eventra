...
//             >
//               <div
//                 className={`mb-3 sm:mb-4 flex items-center justify-center h-10 w-10 sm:h-14 sm:w-14 rounded-full bg-gradient-to-tr ${stat.iconBg} shadow-md`}
//               >
//                 <stat.icon
...
//               <div
//                 className={`absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-br ${stat.glow} dark:from-gray-500/20 dark:to-gray-600/10 blur-2xl opacity-40 -z-10`}
//               />
//             </div>
//           ))}
//         </div>
