...
const VirtualVenueWalkthrough = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden bg-[#07070c] p-4 font-sans text-white selection:bg-indigo-500 selection:text-white md:p-8">
      {/* Title Header */}
      <header className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          <div className="flex items-center gap-2">
            <span className="h-2.5 w-2.5 animate-pulse rounded-full bg-emerald-500" />
            <h1 className="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-500 bg-clip-text text-3xl font-extrabold tracking-tight text-transparent">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 rounded-xl border border-indigo-500/20 bg-slate-900 px-3.5 py-1.5 text-xs font-bold tracking-wider text-indigo-400 uppercase">
            <Eye size={14} />
      ...
      <div className="grid flex-1 grid-cols-1 items-stretch gap-6 lg:grid-cols-3">
        ...
        <div className="group relative flex min-h-[500px] flex-col overflow-hidden rounded-3xl border border-indigo-500/10 bg-slate-950/40 lg:col-span-2">
          <div className="absolute top-4 left-4 z-10 rounded-md border border-indigo-500/20 bg-indigo-500/10 px-2.5 py-1 text-[10px] font-bold tracking-widest text-indigo-400 uppercase backdrop-blur-md">
          ...
          <div
            ...
            className="relative flex flex-1 cursor-default items-center justify-center overflow-hidden p-6 md:p-12"
            style={{ perspective: "1500px" }}
          >
            {/* Oblique Grid base */}
            <div
              className="relative flex aspect-[4/3] w-full max-w-[600px] items-center justify-center rounded-3xl border border-white/5 bg-slate-950/80 shadow-2xl"
              style={{
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-2 rounded-[22px] border border-dashed border-indigo-500/10" />
              ...
              {ROOMS.map((room) => {
                ...
                return (
                  <button
                    ...
                    className="group/item absolute flex transform cursor-pointer flex-col justify-between rounded-2xl border bg-gradient-to-tr p-3 text-white transition-all duration-300 outline-none select-none active:scale-95"
                    style={{
                  ...
                  >
                    ...
                    <div
                      className="pointer-events-none absolute -inset-1 rounded-2xl bg-black/40 blur-md transition-opacity duration-300"
                      style={{
                    ...
                    <div className="flex flex-1 flex-col justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        <div
                          className={`rounded-xl border border-white/10 bg-slate-950/60 p-2 text-indigo-400 transition-colors group-hover/item:text-white`}
                        >
                      ...
                      <div className="mt-2">
                        ...
                        <div className="max-w-full truncate text-xs font-black tracking-tight text-white md:text-sm">
                          {room.label}
                        </div>
                      </div>
                    </div>
                    ...
                    <div
                      className="absolute right-0 bottom-0 left-0 border-t border-white/5 bg-slate-900 opacity-80"
                      style={{
                        height: "10px",
                    ...
                    />
                    <div
                      className="absolute top-0 right-0 bottom-0 border-l border-white/5 bg-slate-950 opacity-80"
                      style={{
                        width: "10px",
          ...
          {/* Footnotes */}
          <div className="flex items-center justify-between border-t border-indigo-500/10 bg-slate-950/60 p-4 text-xs text-gray-500">
        ...
        <div className="relative flex flex-col space-y-6 overflow-hidden rounded-3xl border border-indigo-500/10 bg-slate-950/40 p-6">
          <div className="pointer-events-none absolute top-0 right-0 h-32 w-32 rounded-full bg-indigo-500/5 blur-3xl" />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="rounded-xl border border-white/5 bg-white/5 p-3 text-xs leading-relaxed text-gray-400">
          ...
          <div className="flex-1 space-y-4">
            <h3 className="flex items-center gap-1.5 text-xs font-bold tracking-wider text-gray-500 uppercase">
              <Info size={12} className="text-indigo-400" />
            ...
            <div className="grid grid-cols-1 gap-2.5">
              {Object.entries(selectedRoom.details).map(([key, value]) => (
                <div
                  key={key}
                  className="flex items-center justify-between rounded-xl border border-white/5 bg-white/5 p-3 transition-all hover:border-white/10 hover:bg-white/10"
                >
                  <span className="text-[10px] font-bold text-gray-400 capitalize">
                    {key.replace(/([A-Z])/g, " $1")}
                  </span>
                  <span className="max-w-[180px] truncate text-right text-xs font-semibold text-gray-200">
                    {value}
                  </span>
                </div>
              ))}
            ...
            {selectedRoom.id === "sponsor-exhibition" && (
              <div className="space-y-3 border-t border-white/5 pt-3">
                <div className="flex items-center gap-1.5 text-xs font-black tracking-widest text-gray-400 uppercase">
                  <Award size={14} className="text-indigo-400" />
                  <span>Platinum Partners ({sponsorBooths.length})</span>
                </div>

                <div className="grid max-h-56 grid-cols-1 gap-2.5 overflow-y-auto pr-1">
                  {sponsorBooths.map((booth) => (
                    <button
                      key={booth.id}
                      onClick={() => handleOpenBooth(booth)}
                      className="group flex cursor-pointer items-center justify-between rounded-xl border border-white/5 bg-gradient-to-r from-slate-900 to-indigo-950/30 p-3.5 text-left transition-all duration-300 hover:border-indigo-500/30 hover:to-indigo-950/60"
                    >
                      <div className="flex items-center gap-3">
                        {/* Mock logo shape */}
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-indigo-500/20 bg-slate-950 text-xs font-bold text-indigo-400 transition-colors group-hover:border-indigo-500/50">
                          {booth.sponsorLogo ? (
                            <img
                        ...
                        <div>
                          <div className="text-xs font-black text-white transition-colors group-hover:text-indigo-300">
                            {booth.label}
                          </div>
                          <div className="max-w-[150px] truncate text-[9px] text-gray-500">
                            {booth.sponsorContact || "Sponsor Representative"}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-1 text-[10px] font-bold tracking-widest text-indigo-400 uppercase transition-all group-hover:translate-x-1">
                        <span>Visit</span>
          ...
          <div className="flex items-center justify-between gap-3 rounded-2xl border border-indigo-500/10 bg-indigo-500/5 p-4 text-xs">
            <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="cursor-pointer rounded-lg border border-indigo-500/20 bg-indigo-500/10 p-2 text-indigo-400 transition-colors hover:border-indigo-500/40 hover:bg-indigo-500/20"
