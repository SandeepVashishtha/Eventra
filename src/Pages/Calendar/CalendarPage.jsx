                ...
                <>
                  ...
                  <div className="space-y-4" aria-hidden="true">
                    {[...Array(2)].map((_, i) => (
                      <div
                        key={i}
                        className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 animate-pulse"
                      >
              ...
              {!isLoading && selectedEvents.length > 0
                ? selectedEvents.map((event) => (
                    ...
                    >
                      ...
                      <h4
                        title={event.title}
                        className="mt-2 text-[15px] font-bold text-slate-900 dark:text-white line-clamp-2 break-words leading-snug"
                      >
                        {event.title}
                      </h4>
